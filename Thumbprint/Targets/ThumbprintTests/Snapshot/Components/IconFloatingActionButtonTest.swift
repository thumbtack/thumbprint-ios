...
class IconFloatingActionButtonTest: SnapshotTestCase {
    func testWithPrimaryTheme() {
        let button = IconFloatingActionButton(icon: Icon.notificationAlertsInfoFilledMedium, accessibilityLabel: "Add action")
    ...
    func testChangeIcon() {
        let button = IconFloatingActionButton(icon: Icon.notificationAlertsInfoFilledMedium, accessibilityLabel: "Add action")
        button.setIcon(Icon.notificationAlertsBlockedFilledMedium, accessibilityLabel: "Archive")
        verify(view: button, contentSizeCategories: [.unspecified])
    }
