...
class ButtonTest: SnapshotTestCase {
    ...
    private let icons: [String: Button.Icon?] = [
        "no icon": nil,
        "leading": Button.Icon(.leading, image: Icon.contentActionsFilterSmall),
        "trailing": Button.Icon(.trailing, image: Icon.navigationCaretRightSmall),
    ]
    ...
    func testStretchWidth() {
        ...
        button.icon = .init(.leading, image: Icon.contentActionsFilterSmall)
